...
export const preflopRanges = [
  range("4-max", "CO", "关煞位", "4 人桌 CO 等同最早行动位置，但后面只剩按钮和盲位，默认可比 6-max UTG 宽很多。", ["44+", "A7s+", "ATo+", "KTs+", "KQo", "QTs+", "JTs", "T9s", "98s"], ["弱 offsuit Ax", "低 Kx offsuit", "太差的同花垃圾牌"], "短桌 CO 要主动，但仍要尊重按钮位。"),
  range("4-max", "BTN", "按钮位", "4 人桌按钮位很常争夺盲注，范围可以最宽，但要根据盲位 3-bet 频率调整。", ["22+", "A2s+", "A2o+", "K5s+", "K9o+", "Q8s+", "QTo+", "J8s+", "JTo", "T8s+", "97s+", "86s+"], ["任何两张都开", "被盲位反击后不收缩", "弱牌被跟后多街硬打"], "短桌按钮位靠位置赚钱，不靠乱打赚钱。"),
  range("4-max", "SB", "小盲", "4 人桌小盲经常面对大盲单挑，偷盲机会多，但翻后仍然无位置。", ["22+", "A2s+", "A5o+", "K7s+", "KTo+", "Q9s+", "QJo", "J9s+", "T8s+", "98s-65s"], blindAvoid.sb, "小盲可以更宽偷，但要减少被跟后的无位置大错。"),
  defend("4-max", "BB", "大盲", "4 人桌大盲会频繁防守偷盲，但面对 CO 和 BTN 的范围仍要区别。", ["面对 SB/BTN 可防守较宽", "面对 CO 比面对 BTN 稍紧", "用强 Ax、Broadway 和好阻断牌 3-bet"], blindAvoid.bb, "短桌大盲要防得住偷盲，也要会弃掉无法实现权益的牌。"),

  range("5-max", "HJ", "劫位", "5 人桌 HJ 是最早行动位置，比 6-max HJ 更像短桌 UTG。", ["66+", "ATs+", "AJo+", "KTs+", "KQo", "QTs+", "JTs", "T9s"], ["弱 ATo 以下 offsuit", "KJo 以下弱 Kx", "低同花间隔牌"], "5 人桌 HJ 可以主动，但不要照搬按钮范围。"),
  range("5-max", "CO", "关煞位", "5 人桌 CO 已经接近后位，前面弃牌后可以积极偷盲。", ["44+", "A7s+", "ATo+", "KTs+", "KQo", "QTs+", "JTs", "T9s", "98s", "87s"], ["弱 offsuit Ax", "垃圾同花", "被按钮位频繁 3-bet 后不调整"], "CO 要看按钮位是否会反击。"),
  range("5-max", "BTN", "按钮位", "5 人桌按钮位仍是最有利位置，可以用位置和主动权打开宽范围。", ["22+", "A2s+", "A5o+", "K7s+", "KTo+", "Q9s+", "QJo", "J9s+", "T8s+", "98s-65s"], ["任何两张", "弱牌被 3-bet 后硬跟", "没有翻后计划的偷盲"], "按钮位宽开池，但每手牌都要知道被跟后怎么打。"),
  range("5-max", "SB", "小盲", "5 人桌小盲偷盲频率更高，但仍是全桌最难打的位置之一。", ["33+", "A2s+", "A7o+", "K8s+", "KTo+", "Q9s+", "QJo", "J9s+", "T8s+", "98s"], blindAvoid.sb, "小盲别把短桌主动误解成必须打大底池。"),
  defend("5-max", "BB", "大盲", "5 人桌大盲会经常面对宽范围偷盲，防守可以宽于满员桌。", ["面对 BTN/SB 防守较宽", "面对 HJ 仍要收紧", "用强牌和阻断牌对宽开池 3-bet"], blindAvoid.bb, "先判断对手是短桌宽开，还是早位强范围。"),
